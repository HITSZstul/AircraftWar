...
public class ImageManager {
    ...
    public static BufferedImage ADD_IMAGE;
    ...
    static {
        try {
            ...
            ADD_IMAGE =  ImageIO.read(new FileInputStream("src/images/prop_blood.png"));
            ...
            CLASSNAME_IMAGE_MAP.put(Add.class.getName(), ADD_IMAGE);
            ...
            CLASSNAME_IMAGE_MAP.put(Rfire.class.getName(), PROP_BULLETPLUS);
